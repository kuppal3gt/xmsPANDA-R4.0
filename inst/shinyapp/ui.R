...
#  shinyjs::extendShinyjs(text = jsResetCode),
    ...
    column(12,
        tags$div(id="form",
          h3(tags$img(style="float:left;margin-right:15px;",src="images/xmsPANDA_log.png",height='80px',width="80px"),"xmsPANDA (1.4.0 beta) - R package for biomarker discovery,
